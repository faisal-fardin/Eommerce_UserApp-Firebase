...
mixin _$ProductModel {
  ...
  CategoryModels get category => throw _privateConstructorUsedError;
  set category(CategoryModels value) => throw _privateConstructorUsedError;
...
class _$ProductModelImpl implements _ProductModel {
  ...
  @override
  String toString() {
    return 'ProductModel(id: $id, name: $name, category: $category, price: $price, stock: $stock, imageUrl: $imageUrl, description: $description, avgRating: $avgRating, available: $available, featured: $featured, discount: $discount)';
  }
...
abstract class _ProductModel implements ProductModel {
  ...
  @override
  CategoryModels get category;
  set category(CategoryModels value);
  @override
  num get price;
  set price(num value);
  @override
